...
class PrivacyPolicyViewController: UIViewController {
    ...
    fileprivate let closeButtonImageView = UIImageView()
    ...
    func setupStatusBar() {
        ...
        statusBar.anchor(top: self.view.topAnchor, leading: self.view.leadingAnchor, bottom: nil, trailing: self.view.trailingAnchor, size: .init(width: .zero, height: 50))
        statusBar.backgroundColor = green
        // closeButtonの設定
        let size = CGSize(width: 15, height: 15)
        let closeButton = #imageLiteral(resourceName: "closeButton.png").reSizeImage(reSize: size)
        closeButtonImageView.image = closeButton
        statusBar.addSubview(closeButtonImageView)
        closeButtonImageView.anchor(top: statusBar.layoutMarginsGuide.topAnchor, leading: nil, bottom: statusBar.layoutMarginsGuide.bottomAnchor, trailing: statusBar.layoutMarginsGuide.trailingAnchor, padding: .init(top: 10, left: 0, bottom: 10, right: 10))
        statusBar.addSubview(statusBarHeadlineLabel)
        statusBarHeadlineLabel.fillSuperview()
        statusBarHeadlineLabel.text = "プライバシーポリシー"
    ...
    func setupText() {
        ...
        textView.anchor(top: statusBar.layoutMarginsGuide.bottomAnchor, leading: self.view.layoutMarginsGuide.leadingAnchor, bottom: nil, trailing: self.view.layoutMarginsGuide.trailingAnchor)
        textView.isEditable = false
        textView.textColor = .black
        textView.text = """
        利用規約
        
        この利用規約（以下，「本規約」といいます。）は，このアプリ上で提供するサービス（以下，「本サービス」といいます。）の管理者（以下，「管理者」といいます。）が利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        ...
        ユーザーは，いかなる場合にも，ユーザーIDおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。管理者は，ツイッター社が承認したユーザーのアカウント情報を利用してログインする、または、ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーIDを登録しているユーザー自身による利用とみなします。
        ユーザーのツイッターアカウント情報、ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，管理者に故意又は重大な過失がある場合を除き，管理者は一切の責任を負わないものとします。
