...
class PrivacyPolicyViewController: UIViewController {
    ...
    fileprivate var privacyPolicyHeadline  = ""
    ...
    func setupText() {
        privacyPolicyText = """
        個人情報を収集および管理するアプリ（以下,「本サービス」といいます。）の管理者（以下，「管理者」といいます。）は，における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
